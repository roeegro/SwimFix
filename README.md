...
- **Functionality**:
    ...
    - **Extraction & Visualization** of analytical measures based on the swimmer's pose in each frame of the video:
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNzI2NzI5ODYsMzk1OTQ2MjUxLDg5MD
ExODQwNiwtMTM3NDU0OTIwMF19
-->