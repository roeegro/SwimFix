...
Directory for python files to be stored for activating them for swimming error evaluation. Function and filen aming format is identical to the format required here [Evaluator Module](#evaluator-module)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODAwODQxMjgzLC0xNDg5OTIyMTc5LDE5Nz
