...
In addition the specific upload folder contains 2 csvs in the level of the directories above. The first one "map.csv" contains mapping between error id and its description. The second on "swimmer_errors.csv" contains 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1ODYxMzI0NywyMDQzMjgxMzA1LC0xMz
