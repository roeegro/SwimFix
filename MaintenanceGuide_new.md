...
Directory for future use, where one python function files would be store here. Function naming format is identical to the format required here < link to evaluator >


<!--stackedit_data:
eyJoaXN0b3J5IjpbOTQ1MjYwMjYwLDExNDMxOTg1MDYsLTEyNz
