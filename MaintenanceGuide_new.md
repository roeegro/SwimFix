...
* swimfix_annotated_frames- with annotations of keypoints used after filter and interpolation of all keypoints (See data< link >).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzI3MjYyMTcyLDE0ODQ0MzY5MjgsNjA4MT
EzNTcxLDIxMjcyMzE1MTZdfQ==
-->