...
2) Generate the training model:
	...
	- We strongly recommend you to stick with the default setup as this one worked for us.
...
3) Pre-trained weights setup:
	...
	- Download into `dataset/vgg/` 
		...
		(Taken from this [VGG-19 model](https://gist.github.com/ksimonyan/3785162f95cd2d5fee77) page). The first 10 layers are used as backbone.
4) Train:
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzE0MjYyMzYxLC0zNTcxNTEyMTYsLTE4MT
Q2ODQ3NDIsNTI1NTMxNzk2LC0zMTExNDAxMTUsLTE4OTI5MzY2
OTRdfQ==
-->