...
3) Pre-trained weights setup:
	...
	- Go to  [VGG-19 model](https://gist.github.com/ksimonyan/3785162f95cd2d5fee77)  and downlodit into  `dataset/vgg/`  as  `dataset/vgg/VGG_ILSVRC_19_layers.caffemodel`  and  `dataset/vgg/vgg_deploy.prototxt`. The first 10 layers are used as backbone.
4) Train:
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4OTQzNTUwOTYsLTM1NzE1MTIxNiwtMT
gxNDY4NDc0Miw1MjU1MzE3OTYsLTMxMTE0MDExNSwtMTg5Mjkz
NjY5NF19
-->