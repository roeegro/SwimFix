...
- To generate the lmdb file, run  `python2 c_generateLmdbs.py`  to generate the coco_lmdb and coco-background_lmdb LMDB f. The generated 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMDg2MTkzNTMsMTQzOTk1MDk4LDc2Nz
Q4NzU5NV19
-->